...
# The output is what we put in the quotation marks after using the command print("").
...
# There is no output because in python comments do not get displayed.
# 
...
# There is no output because it's a comment.
...
# It prints out "I am a security analyst."
# 
...
# It prints out "Python is useful for security!"
...
# The output is all of he print statments combined.

# ## Conclusion
# **What are your key takeaways from this lab?**
# 
# I learned about comments and the print statment, and that python is really easy to use.
